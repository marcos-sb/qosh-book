...
To organize storage, HDFS takes from traditional operating systems the concept of \emph{block}: an abstraction of the particular local file system with a double purpose:
